...
const PricingSection = () => {
  ...
  return (
    <section id="pricing" className="relative min-h-screen flex items-center px-6 overflow-hidden bg-circuit-board">
      {/* Enhanced background effects */}
      <div className="absolute inset-0">
        <div className="absolute inset-0 bg-digital-matrix opacity-35" />
        <div className="absolute inset-0 quantum-particles" />
        <div className="absolute top-0 left-0 w-full h-px bg-gradient-to-r from-transparent via-primary to-transparent" />
        <div className="absolute bottom-0 left-0 w-full h-px bg-gradient-to-r from-transparent via-primary to-transparent" />
        <div className="absolute inset-0 bg-neural-network opacity-40" />
