...
const ModesSection = () => {
  ...
  return (
    <section id="modes" className="relative min-h-screen flex items-center px-6 overflow-hidden bg-neural-network">
      {/* Enhanced background effects */}
      <div className="absolute inset-0">
        <div className="absolute inset-0 bg-quantum-field opacity-45" />
